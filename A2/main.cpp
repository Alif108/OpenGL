...
#define SCALE_FACTOR_RATE 0.1       // size increase factor
...
void drawSides()
{
    ...
    glPushMatrix();
    glTranslatef(0, 0, scale_factor * (+MAX_RADIUS));
    drawSquare(scale_factor * (MAX_RADIUS-radius));
    glPopMatrix();
...
{
    glPushMatrix();
    glTranslatef(scale_factor * (MAX_RADIUS-radius), scale_factor * (MAX_RADIUS-radius), scale_factor * (MAX_RADIUS-radius));
    drawSphereOneEighth(scale_factor * radius, 24, 20);
    glPopMatrix();
...
void drawAllCylinders()
{
    ...
    glPushMatrix();
    glTranslatef(scale_factor * (MAX_RADIUS-radius), scale_factor * (MAX_RADIUS-radius), 0);
    drawCylinderOneFourth(scale_factor * radius, 25);
    glPopMatrix();
    ...
    glPushMatrix();
    glTranslatef(0, scale_factor * (MAX_RADIUS-radius), scale_factor * (MAX_RADIUS-radius));
    glRotatef(90, 0, -1, 0);
    drawCylinderOneFourth(scale_factor * radius, 25);
    glPopMatrix();
...
//			pos = pos - l;
			scale_factor -= SCALE_FACTOR_RATE;
			break;
